...
/**
 * @brief Initializes the motor direction pins and sets the robot to a stopped state.
 *        This function should be called during setup to ensure all motors are ready.
 */
...
/**
 * @brief Stops all motors by setting direction pins LOW and PWM to 0.
 *        This function ensures the robot does not move unexpectedly.
 */
